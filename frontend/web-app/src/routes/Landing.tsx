  ...
  const features = [
    {
      ...
      description: 'Children fill in the blanks to create unique stories, practicing vocabulary and grammar in context.',
    },
    {
      icon: <SparklesIcon className="w-6 h-6" />,
      title: 'Automatic Grammar Checks',
      description: 'Real-time feedback helps kids learn from mistakes without frustration, building confidence naturally.',
    },
    {
      icon: <CheckBadgeIcon className="w-6 h-6" />,
      title: 'Kid-Friendly Challenges',
      description: 'Fun, age-appropriate exercises that make language practice feel like play, not homework.',
    },
    {
      icon: <ChartBarIcon className="w-6 h-6" />,
      title: 'Parent Dashboard',
      description: 'Track progress, celebrate achievements, and understand where your child excels or needs support.',
    },
    {
      icon: <GlobeAltIcon className="w-6 h-6" />,
      title: 'Multi-Language Support',
      description: 'Support for dozens of languages, perfect for bilingual families keeping heritage languages alive.',
    },
    {
      icon: <ShieldCheckIcon className="w-6 h-6" />,
      title: 'Safe & Private by Design',
      description: 'Child-safe environment with no ads, strict privacy controls, and COPPA compliance.',
    },
  ];
  ...
  const steps = [
    {
      number: '01',
      title: 'Pick a Topic',
      description: 'Choose from animals, adventures, daily life, or let your child suggest their own story theme.',
    },
    {
      number: '02',
      title: 'Fill the Story Blanks',
      description: 'Kids type words in their native language to complete sentences, making each story unique.',
    },
    {
      number: '03',
      title: 'Get Feedback & Progress',
      description: 'Instant grammar tips and progress tracking help children improve while having fun.',
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                Lingg.ai turns language practice into collaborative stories with grammar feedback and fun challenges.
              </p>
        ...
        <Container>
          ...
          <div className="mt-16 grid md:grid-cols-3 gap-8">
            {pricingTiers.map((tier) => (
              <PriceCard key={tier.id} {...tier} isAnnual={isAnnual} />
            ))}
          </div>
        </Container>
      </section>
        ...
        <Container>
          <div className="text-center">
            ...
            <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
              Join thousands of families keeping their languages alive through the joy of storytelling.
            </p>
            <Link to="/register">
              <Button
                variant="secondary"
