                ...
                <div className="prose prose-lg dark:prose-invert max-w-none">
                    ...
                    <section className="mb-12">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                            At Lingg.ai, we take your privacy seriously. This
                            Privacy Policy explains how we collect, use,
                            disclose, and safeguard your information when you
                            use our service. We are committed to protecting the
                            privacy of children and comply with the Children's
                    ...
                    <section className="mb-12">
                        ...
                        <ul className="list-disc pl-6 space-y-2 text-gray-600 dark:text-gray-300">
                            <li>
                                Account information (parent's name, email
                                address, password)
                            </li>
                            <li>
                                Child profile information (first name, age
                                range, target language)
                            </li>
                    ...
                    <section className="mb-12">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                            ...
                            directly from children under 13 without parental
                            consent. Parents create accounts and manage their
                            children's profiles. We collect only the minimum
                            information necessary to provide our service: the
                            child's first name, age range, and language practice
                            data. We never use children's data for advertising
                            purposes, and we never sell or share children's
                    ...
                    <section className="mb-12">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                            ...
                            transit and at rest. However, no method of
                            transmission over the Internet is 100% secure, and
                    ...
                    <section className="mb-12">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                            ...
                            services. If you wish to delete your account, you
                            may do so at any time from your account settings,
