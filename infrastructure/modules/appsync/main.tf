...
resource "aws_appsync_resolver" "list_stories_resolver" {
  api_id      = aws_appsync_graphql_api.api.id
  type        = "Query"
  field       = "listStories"
  data_source = aws_appsync_datasource.lambda_datasource.name
...
resource "aws_appsync_resolver" "fetch_story_by_id_resolver" {
  api_id      = aws_appsync_graphql_api.api.id
  type        = "Query"
  field       = "fetchStoryById"
  data_source = aws_appsync_datasource.lambda_datasource.name
  kind        = "UNIT"
...
resource "aws_appsync_resolver" "check_template_resolver" {
  api_id      = aws_appsync_graphql_api.api.id
  type        = "Mutation"
  field       = "checkTemplate"
  data_source = aws_appsync_datasource.lambda_datasource.name
